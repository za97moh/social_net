			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					<div class='row'>
						...
						<div class='col-sm-8'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0; word-break: break-word;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					<div class='row'>
						...
						<div class='col-sm-8'>
							<h3><a style='text-decoration:none; word-break: break-word; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							<h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
						</div>
